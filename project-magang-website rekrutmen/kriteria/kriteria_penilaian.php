...
// Ambil data kriteria penilaian dari database
...
<body>
  <div class="d-flex">
    ...
    <div class="sidebar">
      ...
      <a href="kriteria_penilaian.php"><i class="bi bi-sliders"></i> Kriteria Penilaian</a>
      ...
      <div class="container py-4">
        <?php if (isset($_GET['msg']) && $_GET['msg'] === 'sukses'): ?>
          <div class="alert alert-success alert-dismissible fade show" role="alert">
            Data Kriteria Penilaian berhasil disimpan.
        ...
        <?php if (isset($_GET['msg']) && $_GET['msg'] === 'hapus_sukses'): ?>
          <div class="alert alert-success alert-dismissible fade show" role="alert">
            Data Kriteria Penilaian berhasil dihapus.
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>
        <?php endif; ?>
        ...
        <?php if (isset($_GET['msg']) && $_GET['msg'] === 'update_sukses'): ?>
          <div class="alert alert-success alert-dismissible fade show" role="alert">
            Data Kriteria Penilaian berhasil diperbarui.
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>
        <?php endif; ?>

        <a href="tambah_kriteria.php" class="btn btn-primary mb-3"><i class="bi bi-plus-circle"></i> Tambah Data</a>
            ...
            <tbody>
              ...
              while ($row = mysqli_fetch_assoc($result)) {
                echo "<tr>
                  ...
                  <td>
                    <a href='edit_kriteria.php?id={$row['id']}' class='btn btn-success btn-sm'><i class='bi bi-pencil-square'></i> Edit</a>
                    <a href='hapus_kriteria.php?id={$row['id']}' class='btn btn-danger btn-sm' onclick='return confirm(\"Yakin ingin menghapus?\")'><i class='bi bi-trash'></i> Hapus</a>
                  </td>
                </tr>";
                $no++;
              }
