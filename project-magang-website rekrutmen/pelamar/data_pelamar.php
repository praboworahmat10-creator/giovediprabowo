...
// Query data pelamar dari database
      ...
      <div class="container py-4">
        <?php if (isset($_GET['msg']) && $_GET['msg'] === 'sukses'): ?>
          <div class="alert alert-success alert-dismissible fade show" role="alert">
            Data pelamar berhasil disimpan.
...
<?php endif; ?>
        ...
        <a href="tambah_pelamar.php" class="btn btn-primary mb-3"><i class="bi bi-plus-circle"></i> Tambah Data</a>
            ...
            <tbody>
              ...
              while ($row = mysqli_fetch_assoc($result)) {
                echo "<tr>
                  ...
                  <td>{$row['email']}</td>
                  <td>
                    <a href='edit_pelamar.php?id={$row['id']}' class='btn btn-success btn-sm'><i class='bi bi-pencil-square'></i> Edit</a>
                    <a href='hapus_pelamar.php?id={$row['id']}' class='btn btn-danger btn-sm' onclick='return confirm(\"Yakin ingin menghapus?\")'><i class='bi bi-trash'></i> Hapus</a>
                  </td>
                </tr>";
                $no++;
              }
